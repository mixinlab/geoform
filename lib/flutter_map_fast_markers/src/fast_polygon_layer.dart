...
class FastPolygonLayer extends StatelessWidget {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints bc) {
        ...
        for (final polygon in polygons) {
          ...
          polygonsWidget.add(
            CustomPaint(
              painter: FastPolygonPainter(polygon, map.rotationRad),
              size: size,
            ),
          );
        }
...
class FastPolygonPainter extends CustomPainter {
  final FastPolygon polygonOpt;
  final double rotationRad;

  FastPolygonPainter(this.polygonOpt, this.rotationRad);
  ...
  @override
  bool shouldRepaint(FastPolygonPainter oldDelegate) => false;
